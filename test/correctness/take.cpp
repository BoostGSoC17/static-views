...
auto create_impl(std::index_sequence<Is...>)
{
    ...
    BOOST_ATTRIBUTE_UNUSED CONSTEXPR decltype(
        boost::static_views::take(std::declval<std::size_t>())(raw1)) v1[] = {
    ...
    BOOST_ATTRIBUTE_UNUSED CONSTEXPR decltype(
        ...
        boost::static_views::take(Is)(boost::static_views::raw_view(xs)))...};
    STATIC_ASSERT(boost::static_views::detail::utils::all(
    ...
    BOOST_ATTRIBUTE_UNUSED CONSTEXPR decltype(boost::static_views::take(
        ...
        ((void)Is, boost::static_views::take(Is)(decltype(raw2){raw2}))...};
}
