...
struct through_impl : view_adaptor_base<through_impl<View, Proxy>, View> {
  ...
  /// \endverbatim
  explicit BOOST_STATIC_VIEWS_CONSTEXPR through_impl(View &&xs, Proxy &&proxy)
  ...
  /// \endverbatim
  static constexpr auto capacity() noexcept { return Proxy::type::capacity(); }
  ...
  /// fails.
  /// \endverbatim
  BOOST_STATIC_VIEWS_CONSTEXPR auto size() const BOOST_STATIC_VIEWS_NOEXCEPT_IF(
