...
template <class T>
struct conditional_copy_and_move_impl;

template <template <class...> class List, class... Ts>
struct conditional_copy_and_move_impl<List<Ts...>> : Ts... {
    constexpr conditional_copy_and_move_impl()
        = default;
    constexpr conditional_copy_and_move_impl(conditional_copy_and_move_impl const&)
        = default;
    constexpr conditional_copy_and_move_impl(conditional_copy_and_move_impl&&)
        = default;
    constexpr conditional_copy_and_move_impl& operator=(
        conditional_copy_and_move_impl const&) = default;
    constexpr conditional_copy_and_move_impl& operator=(
        conditional_copy_and_move_impl&&) = default;
};

template <class T>
using conditional_copy_and_move = conditional_copy_and_move_impl<
    filter_out_void_t<std::tuple<
