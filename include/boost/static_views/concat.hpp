...
struct concat_impl : view_base {
    ...
    BOOST_STATIC_VIEWS_CONSTEXPR concat_impl(Views&&... xs)
    ...
    BOOST_STATIC_VIEWS_CONSTEXPR auto size() noexcept /* TODO add specifiers */
        -> std::size_t
    {
        std::size_t const capacities[] = {typename Views::type::capacity()...};
        return lfold(raw_view(capacities), std::size_t{});
    }
