...
struct view_adaptor_base : view_base {
  ...
  public:
    ...
    view_adaptor_base(view_adaptor_base const&) noexcept = default;

    BOOST_STATIC_VIEWS_CONSTEXPR
    view_adaptor_base(view_adaptor_base&&) noexcept = default;

    // clang-format off
    BOOST_STATIC_VIEWS_CONSTEXPR
    view_adaptor_base& operator=(view_adaptor_base const&) noexcept = default;

    BOOST_STATIC_VIEWS_CONSTEXPR
    view_adaptor_base& operator=(view_adaptor_base&&) noexcept = default;
    // clang-format on
    /// \}

    ~view_adaptor_base() = default;
